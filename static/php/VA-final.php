...
*/
  ...
  $sql = "SELECT Hydrocode, Source_Type, Latitude, Longitude, Locality, Year_2016, Year_2017, Year_2018, Year_2019, Year_2020 FROM VIRGINIA_TIDAL_FINAL_VERSION_1 WHERE Latitude > 1.1";
