...
function updateGraphs1(currentChecked,saltdata,xtitleName,barchartData1,barchartData2,barchartData3,Timespan,BarChartTimeSpan){
    ...
    if(currentChecked == 'shortTerm')
    {
         ...
         Timespan = document.getElementById("myRange.1").value;
         BarChartTimeSpan = document.getElementById("myRange2.1").value;
    }
    else{
    ...
    //                            Linechart 1 Code 
//<------------------------------------------------------------------------------------>
    Highcharts.chart('dashboard-saltchart1', {
        chart: {
            type: 'line'
        },
    ...
    //                            Saltdial 1 Code Dropped Pinned First
//<------------------------------------------------------------------------------------>
    Highcharts.chart('dashboard-saltdial1', {
...
//                            Barchart 1 Code 
//<------------------------------------------------------------------------------------>
    Highcharts.chart('dashboard-barchart-1.1', {
        chart: {
            type: 'column'
        },
        title: {
...
//<------------------------------------------------------------------------------------>
    ...
    Highcharts.chart('dashboard-barchart-2.1', {
        chart: {
            type: 'column'
        },
        title: {
...
//                            Barchart 3 Code 
//<------------------------------------------------------------------------------------>
    Highcharts.chart('dashboard-barchart-3.1', {
        chart: {
            type: 'column'
        },
        title: {
...
//                              Dropped Pinned Second 

    //                            Saltdial 1 Code 
//<------------------------------------------------------------------------------------>
function updateGraphs2(currentChecked,saltdata,xtitleName,barchartData1,barchartData2,barchartData3,Timespan,BarChartTimeSpan){
    let radios = document.querySelectorAll('input[type="radio"][name="projection"]');
    radios.forEach(function(radio){
        //Checks if Long Term or Short Term is currently selected
        if(radio.checked){
    ...
    if(currentChecked == 'shortTerm')
        {
             [saltdata,xtitleName,barchartData1,barchartData2,barchartData3]= shortTermChanges();
             Timespan = document.getElementById("myRange.2").value;
             BarChartTimeSpan = document.getElementById("myRange2.2").value;
        }
        else{
            [saltdata,xtitleName,barchartData1,barchartData2,barchartData3]= longTermChanges();
            Timespan = document.getElementById("myRange.2").value;
        ...
        Highcharts.chart('dashboard-saltchart2', {
            chart: {
                type: 'line'
            },
    ...
    Highcharts.chart('dashboard-saltdial2', {
...
//                            Barchart 1 Code 
//<------------------------------------------------------------------------------------>
    Highcharts.chart('dashboard-barchart-1.2', {
        chart: {
            type: 'column'
        },
        title: {
...
//<------------------------------------------------------------------------------------>
    ...
    Highcharts.chart('dashboard-barchart-2.2', {
        chart: {
            type: 'column'
        },
        title: {
...
//                            Barchart 3 Code 
//<------------------------------------------------------------------------------------>
    Highcharts.chart('dashboard-barchart-3.2', {
        chart: {
            type: 'column'
        },
        title: {
...
//                              Dropped Pinned Second 
    ...
    //                            Saltdial 1 Code 
//<------------------------------------------------------------------------------------>
function updateGraphs3(currentChecked,saltdata,xtitleName,barchartData1,barchartData2,barchartData3,Timespan,BarChartTimeSpan){
    let radios = document.querySelectorAll('input[type="radio"][name="projection"]');
    radios.forEach(function(radio){
        //Checks if Long Term or Short Term is currently selected
        if(radio.checked){
    ...
    if(currentChecked == 'shortTerm')
        {
             [saltdata,xtitleName,barchartData1,barchartData2,barchartData3]= shortTermChanges();
             Timespan = document.getElementById("myRange.3").value;
             BarChartTimeSpan = document.getElementById("myRange2.3").value;
        }
        else{
            [saltdata,xtitleName,barchartData1,barchartData2,barchartData3]= longTermChanges();
            Timespan = document.getElementById("myRange.3").value;
        ...
        Highcharts.chart('dashboard-saltchart3', {
            chart: {
                type: 'line'
            },
    ...
    Highcharts.chart('dashboard-saltdial3', {
...
//                            Barchart 1 Code 
//<------------------------------------------------------------------------------------>
    Highcharts.chart('dashboard-barchart-1.3', {
        chart: {
            type: 'column'
        },
        title: {
...
//<------------------------------------------------------------------------------------>
    ...
    Highcharts.chart('dashboard-barchart-2.3', {
        chart: {
            type: 'column'
        },
        title: {
...
//                            Barchart 3 Code 
//<------------------------------------------------------------------------------------>
    Highcharts.chart('dashboard-barchart-3.3', {
        chart: {
            type: 'column'
        },
        title: {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    $(function() {
        ...
        $('input[type="range"][id="myRange.1"]').change(function(){
            updateGraphs1()
        })
        $('input[type="range"][id="myRange2.1"]').change(function(){
            updateGraphs1()
        })
        $('input[type="range"][id="myRange.2"]').change(function(){
            updateGraphs2()
        })
        $('input[type="range"][id="myRange2.2"]').change(function(){
            updateGraphs2()
        })
        $('input[type="range"][id="myRange.3"]').change(function(){
            updateGraphs3()
        })
        $('input[type="range"][id="myRange2.3"]').change(function(){
            updateGraphs3()
        })
